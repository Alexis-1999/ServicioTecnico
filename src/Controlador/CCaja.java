...
public class CCaja implements ActionListener,MouseListener{

    /** instancia a nuestra interfaz de usuario*/
    VCaja vista ;
    /** instancia a nuestro modelo */
    MCaja modelo = new MCaja();
