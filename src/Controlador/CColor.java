...
public class CColor implements ActionListener,MouseListener{

    /** instancia a nuestra interfaz de usuario*/
    VColor vista ;
    /** instancia a nuestro modelo */
    MColor modelo = new MColor();
