...
public class CEntidadesEmisoras implements ActionListener,MouseListener{

    /** instancia a nuestra interfaz de usuario*/
    VEntidadesEmisoras vista ;
 ...
 */
    public CEntidadesEmisoras( VEntidadesEmisoras vista )
    {
        this.vista = vista;
    }
  //EVENTOS DEL RATON SOBRE LOS COMPONENTES
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoRuc.setText(String.valueOf(this.vista.tablaConsulta.getValueAt(fila, 2)));
                this.vista.CampoDireccion.setText(String.valueOf(this.vista.tablaConsulta.getValueAt(fila, 3)));
                this.vista.CampoTelefono.setText(String.valueOf(this.vista.tablaConsulta.getValueAt(fila, 4)));
                this.vista.CampoEmail.setText(String.valueOf(this.vista.tablaConsulta.getValueAt(fila, 5)));
    ...
    switch ( AccionMVC.valueOf( e.getActionCommand() ) )
        {
            ...
            case BotonModificar:
                ...
                break;
                case BotonImprimir:
                    modelo.Reportes("InformeEntidadesEmisoras");
                 break;
        }
    }
     ...
     public void limpiarCampos() {
                 //   this.vista.CampoCodigo.setText("");
                    this.vista.CampoRazonSocial.setText("") ;
    ...
    public void cancelar() {
                    limpiarCampos();
                     ...
                     this.modelo.generar_idEntidadesEmisoras();
                     this.vista.CampoCodigo.setText(this.modelo.idEntidadesEmisoras);
