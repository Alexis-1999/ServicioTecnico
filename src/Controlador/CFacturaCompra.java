...
public class CFacturaCompra implements ActionListener {
    ...
    public void iniciar() {
        ...
        this.vista.ComboTipoFactura.setModel(this.modelo.getListaTipoFactura());
        deshabilitaBotones();
    }

    public void actionPerformed(ActionEvent e) {
        switch (CFacturaCompra.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
                ...
                this.vista.txtcodfact.setText(this.modelo.FacturaCompras);
                break;
            case GUARDAR:
                ...
                if (this.modelo.RegistrarCompra(
                    ...
                    for (int i = 0; i < cantidadMercaderias; i++) {
                        ...
                        this.modelo.RegistrarDetalleCompra(this.vista.txtcodfact.getText(), codigoMercadria,
