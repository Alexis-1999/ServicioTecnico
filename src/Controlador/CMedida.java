...
public class CMedida implements ActionListener,MouseListener{

    /** instancia a nuestra interfaz de usuario*/
    VMedida vista ;
    /** instancia a nuestro modelo */
    MMedida modelo = new MMedida();
    ...
    switch ( AccionMVC.valueOf( e.getActionCommand() ) )
        {
            ...
            case BotonModificar:
                ...
                break;
                case BotonImprimir:
                    modelo.Reportes("InformeMedidas");
                 break;
        }
    }
