...
public class CNacionalidad implements ActionListener,MouseListener{

    /** instancia a nuestra interfaz de usuario*/
    VNacionalidad vista ;
    /** instancia a nuestro modelo */
    MNacionalidad modelo = new MNacionalidad();
 ...
 */
    public CNacionalidad( VNacionalidad vista )
    {
        this.vista = vista;
    }
  //EVENTOS DEL RATON SOBRE LOS COMPONENTES
    ...
    public void cancelar() {
                    limpiarCampos();
                     ...
                     this.modelo.generar_idNacionalidad();
