...
public class CPermiso implements ActionListener,MouseListener{
 ...
 */
    public CPermiso( VPermiso vista )
    {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoPermiso.setText(String.valueOf(this.vista.tablaConsulta.getValueAt(fila, 1)));
    ...
    switch ( AccionMVC.valueOf( e.getActionCommand() ) )
        {
            ...
            case BotonGuardar:
                ...
                if ( this.modelo.Guardar(
                        ...
                        this.vista.CampoPermiso.getText() 
                        ) )
                {
                    this.vista.tablaConsulta.setModel( this.modelo.tablaConsulta() );
            ...
            case BotonModificar:
                ...
                break;
                case BotonImprimir:
                    modelo.Reportes("InformePermiso");
                 break;
        }
    }
     ...
     public void limpiarCampos() {
                 //   this.vista.CampoCodigo.setText("");
                    this.vista.CampoPermiso.setText("") ;
                    this.vista.CampoPermiso.requestFocus();
                  
    }
    public void cancelar() {
                    limpiarCampos();
                     
                     this.modelo.generar_idPermisos();
