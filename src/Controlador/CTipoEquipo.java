...
public class CTipoEquipo implements ActionListener,MouseListener{

    /** instancia a nuestra interfaz de usuario*/
    VTipoEquipo vista ;
    /** instancia a nuestro modelo */
    MTipoEquipo modelo = new MTipoEquipo();
 ...
 */
    public CTipoEquipo( VTipoEquipo vista )
    {
        this.vista = vista;
    }
  //EVENTOS DEL RATON SOBRE LOS COMPONENTES
    ...
    switch ( AccionMVC.valueOf( e.getActionCommand() ) )
        {
            ...
            case BotonModificar:
                ...
                break;
                case BotonImprimir:
                    modelo.Reportes("Informetiposequipos");
                 break;
        }
    }
    ...
    public void cancelar() {
                    limpiarCampos();
                     ...
                     this.modelo.generar_idTiposEquipos();
