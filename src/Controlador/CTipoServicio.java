...
public class CTipoServicio implements ActionListener,MouseListener{

    /** instancia a nuestra interfaz de usuario*/
    VTipoServicio vista ;
    /** instancia a nuestro modelo */
    MTipoServicio modelo = new MTipoServicio();
 ...
 */
    public CTipoServicio( VTipoServicio vista )
    {
        this.vista = vista;
    }
  //EVENTOS DEL RATON SOBRE LOS COMPONENTES
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoPrecio.setText(String.valueOf(this.vista.tablaConsulta.getValueAt(fila, 2)));
               ;
    ...
    switch ( AccionMVC.valueOf( e.getActionCommand() ) )
        {
            ...
            case BotonGuardar:
                ...
                if ( this.modelo.Guardar(
                        ...
                        this.vista.CampoPrecio.getText()
     ...
     public void limpiarCampos() {
                 //   this.vista.CampoCodigo.setText("");
                    ...
                    this.vista.CampoDescripcion.requestFocus();
                     this.vista.CampoPrecio.setText("") ;
    ...
    public void cancelar() {
                    limpiarCampos();
                     ...
                     this.modelo.generar_IdtiposServicios();
