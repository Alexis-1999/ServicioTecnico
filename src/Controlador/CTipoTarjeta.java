...
public class CTipoTarjeta implements ActionListener,MouseListener{
 ...
 */
    public CTipoTarjeta( VTipotarjeta vista )
    {
        this.vista = vista;
    }
  //EVENTOS DEL RATON SOBRE LOS COMPONENTES
    ...
    switch ( AccionMVC.valueOf( e.getActionCommand() ) )
        {
            ...
            case BotonModificar:
                ...
                break;
                case BotonImprimir:
                    modelo.Reportes("Informetipotarjetas");
                 break;
        }
    }
    ...
    public void cancelar() {
                    limpiarCampos();
                     ...
                     this.modelo.generar_idTipoTarjetas();
