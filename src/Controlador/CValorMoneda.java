...
public class CValorMoneda implements ActionListener,MouseListener{

    /** instancia a nuestra interfaz de usuario*/
    VValorMoneda vista ;
    /** instancia a nuestro modelo */
    MValorMoneda modelo = new MValorMoneda();
 ...
 */
    public CValorMoneda( VValorMoneda vista )
    {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoMoneda.setText(String.valueOf(this.vista.tablaConsulta.getValueAt(fila, 1)));
                this.vista.CampoSigno.setText(String.valueOf(this.vista.tablaConsulta.getValueAt(fila, 2)));
                this.vista.CampoCambioActual.setText(String.valueOf(this.vista.tablaConsulta.getValueAt(fila, 3)));
    ...
    switch ( AccionMVC.valueOf( e.getActionCommand() ) )
        {
            ...
            case BotonGuardar:
                ...
                if ( this.modelo.Guardar(
                        ...
                        this.vista.CampoMoneda.getText(),
                        this.vista.CampoSigno.getText(),
                        this.vista.CampoCambioActual.getText()
                        ) )
                {
                    this.vista.tablaConsulta.setModel( this.modelo.tablaConsulta() );
            ...
            case BotonModificar:
                ...
                break;
                case BotonImprimir:
                    modelo.Reportes("InformeValorMoneda");
                 break;
        }
    }
     ...
     public void limpiarCampos() {
                 //   this.vista.CampoCodigo.setText("");
                    this.vista.CampoMoneda.setText("") ;
                    this.vista.CampoMoneda.requestFocus();
                     this.vista.CampoSigno.setText("") ;
                    //this.vista.CampoSigno.requestFocus();
                    this.vista.CampoCambioActual.setText("") ;
                    //this.vista.CampoCambioActual.requestFocus();
                  
    }
    public void cancelar() {
                    limpiarCampos();
                     
                     this.modelo.generar_idValorCambio();
