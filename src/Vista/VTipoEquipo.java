 ...
 * @author user
 */
public class VTipoEquipo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(80, 270, 420, 80);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 204));
        jLabel2.setText("Lista de Consulta de Equipo");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(200, 220, 240, 40);
        ...
        CampoDescripcion.setBounds(110, 160, 320, 30);
        ...
        BotonSalir.setBounds(520, 350, 160, 50);
        ...
        BotonImprimir.setBounds(520, 290, 160, 53);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VTipoEquipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VTipoEquipo().setVisible(true);
            }
        });
    }
