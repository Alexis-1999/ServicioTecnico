 ...
 * @author user
 */
public class VTipoFactura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lista de Consulta de Factura");
        ...
        CampoDescripcion.setBounds(110, 160, 240, 30);
        ...
        BotonNuevo.setBounds(730, 110, 170, 60);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VTipoFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VTipoFactura().setVisible(true);
            }
        });
    }
