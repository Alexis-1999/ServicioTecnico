 ...
 * @author user
 */
public class VTipotarjeta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(20, 250, 460, 90);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 204));
        jLabel2.setText("Lista de Consulta de Tarjetas");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(150, 210, 240, 40);
        ...
        BotonSalir.setBounds(490, 330, 160, 50);
        ...
        BotonImprimir.setBounds(490, 280, 160, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VTipotarjeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VTipotarjeta().setVisible(true);
            }
        });
    }
